...
class TxReconciliationTracker::Impl {
    ...
    bool RespondToReconciliationRequest(NodeId peer_id, std::vector<uint8_t>& skdata)
    {
        ...
        if (timely_initial_request) {
            ...
            sketch = recon_state->second.ComputeSketch(sketch_capacity);
            ...
            LogPrint(BCLog::NET, "Responding with an initial sketch to reconciliation initiated by peer=%d: "
