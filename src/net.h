...
public:
    ...
    struct TxRelay {
        ...
        // Transaction ids we want to announce. We always flood them to pre-reconciliation peers,
        // but for the peers registered for reconciliation consider the bool value:
    ...
    void PushTxInventory(const uint256& hash, bool flood)
    {
        ...
        if (!m_tx_relay->filterInventoryKnown.contains(hash)) {
            m_tx_relay->m_txs_to_announce.emplace(hash, flood);
        }
    }
